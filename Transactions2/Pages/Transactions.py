...
# days180 = pd.Timestamp(date.today() - timedelta(days=180))
        ...
        charge90days = np.sum(chargeonlytransactions['Day'] > days90) (df['Total')
        ...
        pivottablenames = pd.pivot_table(df, index=['Customer_Name'], aggfunc={'Total': 'sum', 'Customer_Name': 'count',})
        ...
        pivottabltransactioncountry = pd.pivot_table(df, index=['Country'], aggfunc={'Country': 'count', 'Total': 'sum'})
